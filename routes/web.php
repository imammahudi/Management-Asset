...
// new route for proyek
Route::get('/proyek', 'ProyekController@index');
Route::get('/proyek/create', 'ProyekController@create');
Route::post('/proyek/insert', 'ProyekController@insert');
Route::get('/proyek/{id}/edit', 'ProyekController@edit');
Route::get('/proyek/{id}/idbaru', 'ProyekController@idbaru');
Route::post('/proyek/{id}/update', 'ProyekController@update');
Route::get('/proyek/{id}/delete', 'ProyekController@delete');
Route::get('/proyek/{id}/detail', 'ProyekController@detail');
Route::post('/proyek/{id}/insert_asset', 'ProyekController@insert_asset');
Route::get('/proyek/{id}/hapus', 'ProyekController@hapus');
Route::get('/proyek/{id}/lihat_asset', 'ProyekController@lihat_asset');

// new route proyek for report
Route::get('/reports', 'ProyekController@indexreport');
Route::get('/reports/{id}/exportPdf', 'ProyekController@exportPdf');
/*
|--------------------------------------------------------------------------
| Log Routes
|--------------------------------------------------------------------------
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get(
        'reports/projek',
        ['as' => 'reports/projeks', 'uses' => 'ReportsController@getProjekReport']
    );
    Route::get(
        'reports/export/projek',
        ['as' => 'reports/export/projek', 'uses' => 'ReportsController@exportProjekReport']
    );
