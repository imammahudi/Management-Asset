...
Route::group(['prefix' => 'v1','namespace' => 'Api', 'middleware' => 'api'], function () {
    ...
    Route::group(['prefix' => 'projek'], function () {
        ...
        Route::get('{projek}/checkedout',
            [
                'as' => 'api.projek.checkedout',
                'uses' => 'ProjekController@checkedout'
            ]
        );

        Route::post('{projek}/checkout',
            [
                'as' => 'api.projek.checkedout',
                'uses' => 'ProjekController@checkedout'
            ]
...
Route::group(['prefix' => 'proyek'], function () {
    Route::get('{proyeksId}/seats', [
        'as' => 'api.proyeks.seats',
        'uses' => 'proyekController@seats'
    ]);
}); // Proyek group
...
Route::resource(
    ...
    [
        'names' =>
        [
            'index' => 'api.proyek.index',
            'show' => 'api.proyek.show',
            'store' => 'api.proyek.store',
            'update' => 'api.proyek.update',
            'destroy' => 'api.proyek.destroy'
        ],
        'except' => ['create', 'edit'],
        'parameters' => ['proyeks' => 'proyeks_id']
    ]
); // Licenses resource
