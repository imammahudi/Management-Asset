...
<div class="row">
 ...
 <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-green">
      <div class="inner">
        <h3> {{ number_format($counts['proyek']) }}</h3> 
          <p>{{ trans('total proyek') }}</p>
      </div>
      <div class="icon">
        <i class="fa fa-file-text-o"></i>
      </div>
      @can('index', \App\Models\Proyek::class)
        <a href="{{ url('proyek') }}" class="small-box-footer">{{ trans('general.moreinfo') }} <i class="fa fa-arrow-circle-right"></i></a>
      @endcan
    </div>
  </div><!-- ./col -->
</div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                         ...
                         <div class="col-md-2">
                            ...
                            <a class="btn bg-green" style="width: 100%" href="{{ url('proyek') }}">New Proyek</a>
                            @endcan
                        </div>
                        <div class="col-md-2">
